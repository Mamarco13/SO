...
- permiso x para grupos -> 000010
- permiso x para otros -> 000001
...
~S_IFMT: -> 110 000 111 111 111 111
...
El permiso x de other es (0000001): El permiso x de group es (0000010):
000 000 000 000 000 001 000 000 000 000 000 010
...
struct salida buscar(char nom_dir[1000]){
    ...
    struct salida s; s.bytes = 0; s.n = 0;
